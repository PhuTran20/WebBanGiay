...
// Route::get('/detail/{id}', [CartDetailController::class, 'index'])  ;
...
Route::get('/Add-Cart/{id}', [CartDetailControllerller::class, 'AddCart'] );
Route::get('/Delete-Item-Cart/{id}', [CartDetailController::class, 'DeleteItemCart'] );
//route for admin
