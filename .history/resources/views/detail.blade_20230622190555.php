...
@section('user')
    ...
    <div class="container-fluid py-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        @if($key === 0)
                            <input checked type="radio" class="custom-control-input" id="size-{{$item->id_size}}" name="size-{{$item->id_product}}">
                        @else
                ...
                <div class="d-flex mb-4">
                    ...
                    <form>
                        @foreach($color->sortBy('name_color') as $key => $data)
                        <div class="custom-control custom-radio custom-control-inline">
                            <input {{ $key === 0 ? 'checked' : '' }} type="radio" class="custom-control-input" id="color-{{$data->id_color}}" name="color-{{$data->id_product}}">
            ...
            <a   onclick="AddCart({{ $detail['id'] }})"  href="{{url('/Add-Cart/'.$detail['id'])}}" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Thêm Vào Giỏ Hàng</a>
