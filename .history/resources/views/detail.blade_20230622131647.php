                    ...
                    <form>
                        ...
                        @foreach($product as $item)
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <input type="radio" class="custom-control-input"   name="size-{{$product['id_product']$item->c}}">
                                
                                <label class="custom-control-label" >{{$product['number_size']}}</label>
                    ...
                    <form>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="color-{{$data->id_color}}" name="color-{{$data->id_product}}">
                                ...
                                <label class="custom-control-label" for="color-{{$data->id_color}}">{{$product->name_color}}</label>
                        </div>
                        @endforeach
                    </form>
                </div> --}}
