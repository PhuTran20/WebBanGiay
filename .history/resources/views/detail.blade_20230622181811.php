        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    ...
                    <?php
                    // Custom comparison function for sorting by number_size
                    function compareSizes($a, $b) {
                        if ($a->number_size == $b->number_size) {
                            return 0;
                        }
                        return ($a->number_size < $b->number_size) ? -1 : 1;
                    }
                    
                    // Sort the $size array using the custom comparison function
                    usort($size, 'compareSizes');
                    ?>
