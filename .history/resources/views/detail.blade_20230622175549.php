    ...
    <div class="container-fluid py-5">
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img    class="w-100 h-100" src="/frontend/img/{{$item->image}}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">{{ $item->name_product }}</h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">{{number_format($item->price).' '.'VNĐ' }}</h3>
                ...
                {{-- onclick="AddCart({{ $detail['id'] }})" --}}
                        <a  onclick="AddCart({{$item->id}})"   href="Javascript:" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Thêm Vào Giỏ Hàng</a>
