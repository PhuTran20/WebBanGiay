...
<div class="container-fluid py-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <div class="d-flex ">
                ...
                <p style="font-size:
                    ...
                    700;
                    line-height:
                    22.4px" class="  mb-4">{{ number_format($detail->price, 0, '.', '.') . ' VNĐ' }}</p>
            </div>
            ...
            <div class="d-flex mb-3">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <input checked type="radio" class="custom-control-input" id="size-{{$item->id_size}}"
            ...
            <div class="d-flex mb-4">
                ...
                <form>
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input checked type="radio" class="custom-control-input" id="color-{{$data->id_color}}"
  ...
  #scrollableDiv::-webkit-scrollbar-track {
                            ...
                            @if($item->status==1)
                                ...
                                <div>
                                    ...
                                    @foreach($reply_comment as $data)
                                        ...
                                        @endif
                                    @endforeach
                                    {{-- End of loop for displaying replies --}}
                                </div>
                            @endif
                        @endforeach
                        @if ($count === 0)
          ...
          <div class="col-md-6">
            <div>
                ...
                <div>
                    ...
                    @if( $data1 == null)
                    <a href="{{URL::to('/login')}}" class="nav-item nav-link">
                            ...
                            @for($count=1;$count<=5;$count++)
                             @php
                              if($count<=$rating){
                                ...
                                <li title="star_rating" id="{{$detail['id']}}-{{$count}}-{{$data1->id??""}}"
                                data-index="{{$count}}" data-id_user="{{$data1->id??""}}" data-id_product="{{$detail['id']}}" 
    ...
    <script>
        ...
        //đánh giá sao
        function remove_background(id_product,id_user) {
            for (var count = 1; count <= 5; count++) {
                $('#' + id_product + '-' + count+'-'+id_user).css('color', '#ccc');
            }
        }
        ...
        $(document).on('mouseenter', '.rating', function () {
            ...
            remove_background(id_product,id_user);
            for (var count = 1; count <= index; count++) {
                $('#' + id_product + '-' + count+'-'+id_user).css('color', 'rgb(209,156,151)');
            }
        });
